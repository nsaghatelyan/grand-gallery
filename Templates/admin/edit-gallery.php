...
<div class="wrap gdfrm_edit_form_container">
    <div class="gdfrm_nav">
        <div class="form_title_div">
            <input type="text" id="form_name" value="<?php echo $gallery->getName(); ?>">
                ...
                <div id="gdgallery_general_settings">
                    <ul cass="gdgallery_general_settings">
                        <li>
                            <h4>Description</h4>
                            <?php
                            wp_editor($gallery_data->description, "gdgallery_description_" . $id, array(
                                'media_buttons' => false,
                                'textarea_rows' => 5,
                                'tabindex' => 4
                            ));
                        ...
                        <li>
                            <h4>Display Type</h4>
                            <select name="gdgallery_display_type_<?= $id ?>">
                        ...
                        <li>
                            <h4>Hover effect</h4>
                            <select name="gdgallery_hovver_effect_<?= $id ?>">
